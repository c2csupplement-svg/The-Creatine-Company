  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      const slides = Array.from(
        slider.querySelectorAll<HTMLElement>(".mango-slide")
      );
  ...
  return (
    ...
    >
      ...
      <section className="mango">
        ...
        <div className="mango-right">
          <div
            ref={mangoSliderRef}
            className="mango-scroll"
          >
            {products.map((item) => (
              <div
                className="mango-slide"
                key={item.id}
              >
                <Link
                  href={item.link}
                  className="mango-card-link"
                >
          ...
          <div className="mango-slider-arrows">
            <button
              type="button"
              className="mango-slider-arrow"
              onClick={() =>
