                ...
                >
                  ...
                  >
                    {isArabic ? (
                      <>
                        ارتقِ بمستواك مع{" "}
                        <span className="text-[#ffb703]">الكرياتين</span>
                      </>
                    ) : isFarsi ? (
                      <>
                        سطح خود را با <span className="text-[#ffb703]">کراتین</span> ارتقا
                        دهید
                      </>
                    ) : (
                      <>
                        LEVEL UP WITH <span className="ml-5 text-[#ffb703]">CREATINE</span>
                      </>
                    )}
                  </h1>
