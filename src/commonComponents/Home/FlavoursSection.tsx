  ...
  const scrollSlider = (direction: "left" | "right") => {
    ...
    if (direction === "right") {
      ...
      setCurrentIndex((prev) =>
        Math.min(prev + 1, FLAVOURS.length - 1)
      );
    } else {
      slider.scrollBy({
        left: -slideWidth,
    ...
    >
      <div
        className="
          ...
          lg:gap-8
          xl:gap-10
          min-[1440px]:max-w-[1500px]
          min-[1440px]:grid-cols-[0.85fr_1.15fr]
          min-[1440px]:gap-12
        ...
        <div>
          ...
          >
            <h2
              ...
              leading-[0.84]
              tracking-[-0.02em]
              text-[clamp(1.8rem,10vw,2.5rem)]

              min-[375px]:text-[clamp(2.2rem,10vw,3.2rem)]
              min-[480px]:text-[clamp(2.8rem,9vw,4.2rem)]
            ...
            >
              <span
                ...
                text-[clamp(1.8rem,9vw,2.4rem)]

                min-[375px]:text-[clamp(2rem,9.5vw,3rem)]
                min-[480px]:text-[clamp(2.5rem,8.5vw,4rem)]
                sm:text-[clamp(3rem,7vw,4.5rem)]
                md:text-[clamp(2.8rem,5.5vw,4.2rem)]
                lg:text-[clamp(3.2rem,5vw,4.8rem)]
                xl:text-[clamp(3.5rem,4.8vw,5.2rem)]
              ...
              return (
                <div
                  ...
                  className={`
                    ...
                    min-[375px]:h-[clamp(270px,78vw,360px)]
                    min-[480px]:h-[clamp(340px,72vw,430px)]
                    sm:h-[400px]
                    md:h-[420px]
                    lg:h-[440px]
                    xl:h-[470px]
          ...
          >
            <button
              ...
              className="
                ...
                min-[375px]:h-[38px]
                min-[375px]:w-[38px]
                min-[375px]:min-h-[38px]
                min-[375px]:min-w-[38px]
                min-[375px]:text-[20px]

                min-[480px]:h-[42px]
                min-[480px]:w-[42px]
                min-[480px]:min-h-[42px]
                min-[480px]:min-w-[42px]
                min-[480px]:text-[22px]
                ...
                min-[1920px]:h-[58px]
                min-[1920px]:w-[58px]
                min-[1920px]:min-h-[58px]
                min-[1920px]:min-w-[58px]
