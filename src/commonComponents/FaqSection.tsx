...
const FAQS = {
  ...
  fa: [
    {
      q: "اگر کراتین خام ارزان است، چرا قیمت بسته‌های بزرگ ۶۹ درهم است؟",
      a: "هزینه کراتین مونوهیدرات خام در یک وعده استاندارد ۵ گرمی حدود ۰٫۱۹ درهم است. این ماده ارزان و به‌وفور در دسترس است. مدل سنتی بسته‌های بزرگ گران به نظر می‌رسد، زیرا شما مجبورید مقدار مورد نیاز برای ۹۰ روز را یکجا خریداری کنید. ما محصول را به یک وعده روزانه تقسیم کرده‌ایم. شما برای هر ساشه فقط ۱ درهم پرداخت می‌کنید، نه ۱۵۰ درهم برای یک ظرف پلاستیکی. دقیقاً همان مقداری را می‌خرید که نیاز دارید.",
    },
    {
      q: "چطور کراتین ۱ درهمی می‌تواند ایمن و اصل باشد؟",
      a: "قیمت پایین به معنای کیفیت پایین نیست. بخش باقی‌مانده از ۱ درهم صرف تورین، فویل با محافظت بالا، بسته‌بندی، ارسال، مالیات GST، حاشیه سود منطقی و آزمایش دقیق هر بچ در آزمایشگاه‌های دارای اعتبار NABL می‌شود. ما تمام جزئیات هزینه را در سایت منتشر می‌کنیم. علاوه بر این، لازم نیست فقط به حرف ما اعتماد کنید. روی هر ساشه یک کد QR قرار دارد. آن را اسکن کنید تا گواهی آنالیز دائمی (COA) همان بچ را از یک آزمایشگاه مورد تأیید NABL مشاهده کنید. بر اساس شواهد تصمیم بگیرید، نه قیمت.",
    },
    {
      q: "چرا ساشه‌های تک‌مصرف به جای بسته بزرگ؟",
      a: "چون بسته‌های بزرگ در برابر رطوبت مقاوم نیستند. وقتی یک ظرف را در هوای مرطوب باز می‌کنید، رطوبت وارد آن می‌شود. پودر به هم می‌چسبد و ممکن است به کراتینین تبدیل شود و پیمانه نیز معمولاً تا هفته دوم گم می‌شود. ما ۵ گرم کراتین میکرونایز ۱۰۰٪ با مش ۲۰۰ را داخل فویل با محافظت بالا بسته‌بندی کرده‌ایم. محصول خشک می‌ماند و مقدار آن دقیقاً از قبل اندازه‌گیری شده است. بدون پودر گلوله‌شده، بدون جست‌وجوی پیمانه و بدون حدس زدن مقدار مصرف.",
    },
    {
      q: "چه زمانی باید آن را مصرف کنم و آیا نیاز به بارگیری دارم؟",
      a: "هر زمانی که راحت‌تر می‌توانید به خاطر بسپارید، هر روز آن را مصرف کنید. کراتین با حفظ سطح ذخایر داخل عضلات در طول زمان عمل می‌کند، بنابراین استمرار روزانه بسیار مهم‌تر از زمان مصرف است. مرحله بارگیری، یعنی ۲۰ گرم در روز به مدت یک هفته، ذخایر عضلات را سریع‌تر پر می‌کند اما کاملاً اختیاری است. مصرف روزانه یک ساشه ۵ گرمی می‌تواند عضلات شما را تقریباً طی ۲۸ روز به سطح اشباع برساند.",
    },
    {
      q: "من گیاه‌خوار هستم. آیا این موضوع روی عملکرد کراتین تأثیر دارد؟",
      a: "بله. کراتین غذایی تقریباً به طور کامل از گوشت و ماهی دریافت می‌شود. مطالعات کنترل‌شده با نمونه‌برداری از عضله نشان می‌دهند که گیاه‌خواران معمولاً ذخایر پایه کراتین عضلانی پایین‌تری دارند (۱۱۷ در مقابل ۱۳۰ میلی‌مول بر کیلوگرم). بنابراین فضای بیشتری برای افزایش ذخایر دارند و ممکن است پاسخ بیشتری به مصرف روزانه مکمل نشان دهند. ساشه‌های ما ۱۰۰٪ گیاهی هستند.",
    },
    {
      q: "آیا کراتین باعث ریزش مو یا آسیب کلیه می‌شود؟",
      a: "انجمن بین‌المللی تغذیه ورزشی (ISSN) نتیجه گرفته است که کراتین مونوهیدرات برای افراد سالم ایمن و قابل تحمل است. در افراد سالم، کراتین به عملکرد کلیه آسیب نمی‌زند. نگرانی درباره ریزش مو از یک مطالعه در سال ۲۰۰۹ ناشی شد که DHT را اندازه‌گیری کرد و نتایج آن هرگز تکرار نشد. یک متاآنالیز در سال ۲۰۲۱ و یک مطالعه تصادفی کنترل‌شده در سال ۲۰۲۵ که مستقیماً فولیکول‌های مو را بررسی کرد نیز ارتباطی بین کراتین و ریزش مو پیدا نکردند.",
    },
  ],
};
...
export default function FaqSection() {
  ...
  return (
    <section
      dir={isRTL ? "rtl" : "ltr"}
      className="relative w-full bg-[#fdf1da] px-6 pb-20 pt-[70px] text-[#3a2416] sm:px-10"
    >
      <div className="mx-auto w-full max-w-4xl">
        <div className="max-w-[940px]">
          <h2
            className={`${anton.className} m-0 text-5xl leading-none text-[#502300] sm:text-[3.75rem] md:text-[4.375rem] ${language !== "en"?"pb-2":"pb-0"}`}
          >
            {heading.first}
          </h2>

          <div className="-mt-2 inline-block bg-[#a87847] px-6 py-1 rotate-[2.27deg] sm:px-8">
            <h2
              className={`${anton.className} m-0 text-5xl leading-none text-white sm:text-[3.75rem] md:text-[4.375rem]`}
            >
              {heading.second}
            </h2>
          </div>
            ...
            return (
              <div key={item.q} className="w-full">
                <button
                  ...
                  className={`${anton.className} flex w-full cursor-pointer items-center justify-between rounded-md border-0 px-5 py-5 text-lg font-medium text-white transition-colors duration-300 sm:text-2xl ${
                    isOpen
                      ? "bg-[#5c3a22]"
                      : "bg-[#82572b]"
                  }`}
                >
                  ...
                  <span className="ml-4 flex h-14 w-14 flex-none items-center justify-center rounded border-2 border-white">
                    {isOpen ? (
                ...
                >
                  <div className="min-h-0 overflow-hidden">
                    <div
                      className={`${mono.className} px-5 py-4 text-sm leading-[1.625] text-[#3a2416] sm:text-base`}
                    >
                      {item.a}
                    </div>
                  </div>
